...
const RichTextExample = (props: {model: IFluidDraftJsObject, currentSlateValue: any}) => {
  const initialValue = props.currentSlateValue
  ...
  const onChanged = value => {
    console.log('slate data value: ', value);
    setValue(value);
